...
const GridMap: React.FC<GridMapProps> = ({ onStateClick, onLouisianaClick }) => {
  const grid = [
    // Row 0
    [{ state: "AK", col: 0 }, { state: "ME", col: 10 }],
    // Row 1
    [{ state: "WI", col: 6 }, { state: "VT", col: 9 }, { state: "NH", col: 10 }],
    // Row 2
    [
      { state: "WA", col: 0 },
      { state: "ID", col: 1 },
  ...
  const clickableStates = [
    "AZ", "CA", "FL", "GA", "IL", "ID", "IN", "KS", "KY", "LA",
    "MD", "MN", "MS", "NM", "NC", "OH", "OR", "SC", "TN", "TX",
    "UT", "WA", "VT", "WV", "WY"
  ];
    ...
    <div className="w-full max-w-2xl mx-auto p-4">
      ...
      <div className="mt-6 grid grid-cols-2 md:grid-cols-5 gap-2 text-sm">
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: "#93C5C5" }}></div>
        ...
        <div className="flex items-center gap-2">
          <div className="w-4 h-4 rounded" style={{ backgroundColor: "#FFCCBC" }}></div>
