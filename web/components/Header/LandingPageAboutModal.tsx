    ...
    <div className={styles.modalOverlay} onClick={handleOverlayClick}>
      <div className={styles.modalContent}>
        ...
        <div className={styles.tabContainer}>
          ...
          <button
            className={`${styles.tab} ${activeTab === 'legalDisclaimer' ? styles.active : ''}`}
            onClick={() => setActiveTab('legalDisclaimer')}
          >
            Legal Disclaimer
          </button>
        </div>
        ...
        <div className={styles.modalBody}>
          {activeTab === 'about' && (
            <>
              ...
              <section className={styles.modalSection}>
                <p>A special thanks goes out to Huy Dao, Bailey Passamore, and Eliora Henzler.</p>
              </section>
            </>
          )}
          ...
          {activeTab === 'team' && (
            <>
              <h3>Core team</h3>
              <section className={styles.modalSection}>
                <p><strong>Sam Stecklow</strong> (he/him) is an investigative journalist and FOIA fellow with Invisible Institute. He works on Invisible Institute&apos;s Civic Police Data Project and investigations.</p>
              </section>
              <section className={styles.modalSection}>
               <p><strong>Ayyub Ibrahim</strong> (he/him) is a software developer at the Berkeley Institute for Data Science on the California Law Enforcement Accountability Network (CLEAN) team. He previously served as the Director of Research for the Innocence Project New Orleans&apos; Louisiana Law Enforcement Accountability Database <a href="https://llead.co" target="_blank" rel="noopener noreferrer" style={linkStyle}>(LLEAD)</a> and is the founder of <a href="https://github.com/ayyubibrahimi/mljusticelab-tools" target="_blank" rel="noopener noreferrer" style={linkStyle}>Machine Learning Justice Lab</a>. He previously worked for the Amman Center for Human Rights Studies, the World Justice Project, and the Office of the Independent Police Monitor (New Orleans).</p>
              </section>
              <section className={styles.modalSection}>
                <p><strong>Tarak Shah</strong> (he/they) is a data scientist at the Human Rights Data Analysis Group. He works with community organizations, lawyers, journalists, international human rights institutions, and transitional justice mechanisms to support campaigns for accountability through quantitative analysis. He currently serves as program manager of the Community Law Enforcement Network, an interdisciplinary effort to collect and publish records related to police force and misconduct in California.</p>
              </section>
              <section className={styles.modalSection}>
                <p><strong>Maheen Khan</strong> is Invisible Institute&apos;s Director of Technology. She studied Information Analysis and Computer Science at the University of Michigan. At the Invisible Institute, she primarily works to maintain the Civic Police Data Project, and to expand the police misconduct tool to other cities.</p>
              </section>
              <section className={styles.modalSection}>
                <p><strong>Chaclyn Hunt</strong> is Invisible Institute&apos;s legal director and a civil rights attorney.</p>
              </section>
            </>
          )}

          {activeTab === 'legalDisclaimer' && (
            <section className={styles.modalSection}>
              <p>Legal disclaimer content goes here.</p>
            </section>
          )}
        </div>
      </div>
